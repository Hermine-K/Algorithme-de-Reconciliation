...
⚠ : Les arbres Nawick doivent toujours avoir trois lettres pour les noms d'espèces et des noeuds internes numérotés, comme dans le premier exemple fourni sinon les options loss et vérif ne pourront pas être utilisées. 
